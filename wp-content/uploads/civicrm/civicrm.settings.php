...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://portland:2MPA79BX@localhost/portland_wordpress?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://portland:2MPA79BX@localhost/portland_civicrm?new_link=true');
  }
}
...
$civicrm_root = '/home/portland/www/www/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/portland/www/www/wp-content/uploads/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://crm.portlandboxingclub.org/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '7bd2657bd5c26b78fdb08464312d3ce7');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home2/portlbq8/public_html/wp-content/uploads/civicrm/templates_c//mail.log');
// }
