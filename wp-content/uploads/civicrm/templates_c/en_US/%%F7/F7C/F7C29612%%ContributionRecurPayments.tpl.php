<?php /* Smarty version 2.6.31, created on 2021-02-17 01:15:39
         compiled from CRM/Contribute/Page/ContributionRecurPayments.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contribute/Page/ContributionRecurPayments.tpl', 1, false),array('block', 'ts', 'CRM/Contribute/Page/ContributionRecurPayments.tpl', 3, false),array('block', 'icon', 'CRM/Contribute/Page/ContributionRecurPayments.tpl', 39, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if ($this->_tpl_vars['contributionsCount'] > 0): ?>
...
<?php else: ?>
  <div class="messages status no-popup">
    ...
    <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>No contributions have been recorded for this recurring contribution.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
  </div>
<?php endif; ?>
