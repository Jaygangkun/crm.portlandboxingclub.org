...
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><td <?php if ($this->_tpl_vars['colspan']): ?> colspan="<?php echo $this->_tpl_vars['colspan']; ?>
" <?php else: ?> colspan="2" <?php endif; ?> <?php if ($this->_tpl_vars['class']): ?> class="<?php echo $this->_tpl_vars['class']; ?>
" <?php endif; ?>>
  <?php $this->assign('hideRelativeLabel', ((is_array($_tmp=@$this->_tpl_vars['hideRelativeLabel'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))); ?>
