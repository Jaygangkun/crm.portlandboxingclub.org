...
{php}
if(isset($_GET['import']) && $_GET['import'] == 'squarespace'){
  CRM_Utils_System::setTitle('Import Squarespace', 'Import Squarespace');
  {/php}
  <div class="crm-title">
    <h1 class="title">Import Squarespace</h1>
  </div>
  {php}
}
else if(isset($_GET['import']) && $_GET['import'] == 'square'){
  CRM_Utils_System::setTitle('Import Square', 'Import Square');
  {/php}
  <div class="crm-title">
    <h1 class="title">Import Square</h1>
  </div>
  {php}
}
else{
